...
class Header extends Layout {
	...
	function compose($type, $title = null, $meta_keywords = null,$meta_description = null, $page = null){
		...
		//rss feed
		$head .= '<link href="/blog/feed/rss.php" title="RSS" type="application/rss+xml" rel="alternate">';
		...
		switch( (string) $type){
			...
			$head .= "<link rel=\"stylesheet\" type=\"text/css\" href=\"../../../blog/css/main.css\"/>";
			// yes, we can use this to easily update content in our views!
			break;
			
			default:
			$head .= "<link rel=\"stylesheet\" type=\"text/css\" href=\"../../../blog/css/default.css\"/>";
			break;
			
		}
		$head .= "</head><body id='".$page."'><div id='mainwrap'>";
		return $head;
	}
...
class Footer extends Layout{
	...
	function foundation($type){
		...
		switch( (string) $type){
			case "main":
				$footer = "</div><div class='footer'></div><script type='text/javascript' language='javascript'>var google = \"something from google\";</script></body></html>";
			break;
